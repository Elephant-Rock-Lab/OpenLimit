...
// Adapter implements providers.Adapter for Mistral.
// Mistral exposes an OpenAI-compatible API, so request/response shapes are
...
// New creates a new Mistral adapter.
...
// CompleteChat sends a non-streaming chat completion request to Mistral.
...
// StreamChat sends a streaming chat completion request to Mistral.
